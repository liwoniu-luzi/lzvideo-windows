...
void main() {
  test('maintained build reads updates and release assets from the same repository', () {
    expect(VersionUtil.projectUrl, 'https://github.com/liwoniu-luzi/lzvideo-windows');
    expect(VersionUtil.issuesUrl, '${VersionUtil.projectUrl}/issues');
    expect(VersionUtil.releaseUrl, contains('/repos/liwoniu-luzi/lzvideo-windows/releases'));
  });
